...
AUTO_APPROVE_THRESHOLD = 0.90  # >= 73% → no human, agent commits the comment directly
ESCALATE_THRESHOLD = 0.83     # < 58% → escalate: agent asks the reviewer specific questions
