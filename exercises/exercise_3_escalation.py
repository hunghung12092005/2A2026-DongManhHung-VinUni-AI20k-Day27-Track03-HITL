    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = llm.invoke([
            {"role": "system", "content": (
                ...
                "If confidence is below 0.60, populate escalation_questions with 2 to 4 "
                "specific, context-rich questions that reference the relevant file or diff area."
            )},
        ...
        refined = llm.invoke([
            {
                "role": "system",
                "content": (
                    "Refine the PR review using the reviewer's answers. "
                    "Return updated structured output with summary, comments, confidence, "
                    "risk_factors, and any remaining escalation_questions."
                ),
            },
            {
                "role": "user",
